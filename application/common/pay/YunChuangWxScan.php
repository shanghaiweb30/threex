...
use think\Request;
use app\common\Pay;
class YunChuangWxScan extends Pay
{
    ...
    public function order($outTradeNo,$subject,$totalAmount)
    {
        ...
        $params['notifyurl'] = Request::instance()->domain().'/pay/notify/YunChuangWxScan';
        $params['returnurl'] = Request::instance()->domain().'/pay/page/YunChuangWxScan';
    ...
    public function notify_callback($params,$order)
    {
        ...
        if($sign == $mysign) {
            if($status == '1') {
                ...
                record_file_log('YunChuangWxScan_notify_success',$order->trade_no);
                echo 'Success';
            } else {
                echo 'fail';
            }
