...
use think\Request;
use app\common\Pay;
class YunChuangWxWap extends Pay
{
    ...
    public function order($outTradeNo,$subject,$totalAmount)
    {
        ...
        $params['notifyurl'] = Request::instance()->domain().'/pay/notify/YunChuangWxWap';
        $params['returnurl'] = Request::instance()->domain().'/pay/page/YunChuangWxWap';
    ...
    public function notify_callback($params,$order)
    {
        ...
        if($sign == $mysign) {
            if($status == '1') {
                ...
                record_file_log('YunChuangWxWap_notify_success',$order->trade_no);
                echo 'Success';
            } else {
                echo 'fail';
            }
