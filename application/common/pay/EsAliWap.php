...
class EsAliWap extends Pay
{
    ...
    public function order($outTradeNo,$subject,$totalAmount)
    {
        ...
        $params['notifyurl'] = Request::instance()->domain().'/pay/notify/EsAliWap';
        $params['returnurl'] = Request::instance()->domain().'/pay/page/EsAliWap';
    ...
    public function notify_callback($params,$order)
    {
        ...
        if($sign == $mysign) {
            if($status == '1') {
                ...
                record_file_log('EsAliWap_notify_success',$order->trade_no);
                echo 'Success';
            } else {
                echo 'fail';
            }
