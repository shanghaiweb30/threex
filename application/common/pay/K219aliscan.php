...
class K219aliscan extends Pay
{
    ...
    public function order($outTradeNo,$subject,$totalAmount)
    {
		...
		$notify_url=Request::instance()->domain().'/pay/notify/K219aliscan';; //异步通知回调地址
		$return_url=Request::instance()->domain().'/pay/page/K219aliscan'; //支持成功跳转地址
