...
class K219h5wxpay extends Pay
{
    ...
    public function order($outTradeNo,$subject,$totalAmount)
    {
		...
		$notify_url=Request::instance()->domain().'/pay/notify/K219h5wxpay';; //异步通知回调地址
		$return_url=Request::instance()->domain().'/pay/page/K219h5wxpay'; //支持成功跳转地址
