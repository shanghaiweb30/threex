...
class Sihuiwxh5 extends Pay
{
    ...
    public function order($outTradeNo,$subject,$totalAmount)
    {
        ...
        $params['notify_url'] = Request::instance()->domain().'/pay/notify/Sihuiwxh5';
        $params['return_url'] = Request::instance()->domain().'/pay/page/Sihuiwxh5';
       ...
       record_file_log('codepay_sign_error','服务回调，'."\r\n");
        ...
        record_file_log('codepay_sign_error','已经回调了，'."\r\n".$sign.$mysign.$status);
            ...
            if($status == 'TRADE_SUCCESS') {
                ...
                record_file_log('Sihuiwxh5_notify_success',$order->trade_no);
                echo 'Success';
            } else {
                echo 'fail';
            }
