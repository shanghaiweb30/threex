...
use think\Request;
use app\common\Pay;
class YunChuangHbScan extends Pay
{
    ...
    public function order($outTradeNo,$subject,$totalAmount)
    {
        ...
        $params['notifyurl'] = Request::instance()->domain().'/pay/notify/YunChuangHbScan';
        $params['returnurl'] = Request::instance()->domain().'/pay/page/YunChuangHbScan';
    ...
    public function notify_callback($params,$order)
    {
        ...
        if($sign == $mysign) {
            if($status == '1') {
                ...
                record_file_log('YunChuangHbScan_notify_success',$order->trade_no);
                echo 'Success';
            } else {
                echo 'fail';
            }
