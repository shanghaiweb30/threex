...
class UcykjAlipay extends Pay
{
    ...
    public function order($outTradeNo,$subject,$totalAmount)
    {
        $param = [
			...
			'notify_url'=>Request::instance()->domain().'/pay/notify/UcykjAlipay',
			'return_url'=>Request::instance()->domain().'/pay/page/UcykjAlipay',
		];
    ...
    {
        //file_put_contents("./logs.txt",'UckjAlipay=='.print_r($params, true) . PHP_EOL);
        ...
        if($params['sign'] == $mysign) {
            if($status == 'TRADE_SUCCESS') {
                ...
                //record_file_log('UckjAlipay_notify_success',$order->trade_no);
                echo 'success';
            } else {
                echo 'fail';
            }
