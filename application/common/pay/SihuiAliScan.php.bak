...
use think\Request;
use app\common\Pay;
class SihuiAliScan extends Pay
{
    ...
    public function order($outTradeNo,$subject,$totalAmount)
    {
        ...
        $params['type'] = 'alipay';
        $params['notify_url'] = Request::instance()->domain().'/pay/notify/SihuiAliScan';
        $params['return_url'] = Request::instance()->domain().'/pay/page/SihuiAliScan';
       ...
       record_file_log('codepay_sign_error','服务回调，'."\r\n");
        ...
        record_file_log('codepay_sign_error','已经回调了，'."\r\n".$sign.$mysign.$status);
            ...
            if($status == 'TRADE_SUCCESS') {
                ...
                record_file_log('SihuiAliScan_notify_success',$order->trade_no);
                echo 'Success';
            } else {
                echo 'fail';
            }
