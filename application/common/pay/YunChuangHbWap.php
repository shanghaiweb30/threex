...
use think\Request;
use app\common\Pay;
class YunChuangHbWap extends Pay
{
    ...
    public function order($outTradeNo,$subject,$totalAmount)
    {
        ...
        $params['notifyurl'] = Request::instance()->domain().'/pay/notify/YunChuangHbWap';
        $params['returnurl'] = Request::instance()->domain().'/pay/page/YunChuangHbWap';
    ...
    public function notify_callback($params,$order)
    {
        ...
        if($sign == $mysign) {
            if($status == '1') {
                ...
                record_file_log('YunChuangHbWap_notify_success',$order->trade_no);
                echo 'Success';
            } else {
                echo 'fail';
            }
